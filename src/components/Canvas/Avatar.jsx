...
Command: npx gltfjsx@6.2.13 public/avatar_model/avatar.glb 
*/
...
export function Avatar(props) {
  const { nodes, materials } = useGLTF('avatar_model/avatar.glb')
  return (
    <group {...props} dispose={null}>
      <primitive object={nodes.Hips} scale={0.02}/>
...
useGLTF.preload('avatar_model/avatar.glb')
